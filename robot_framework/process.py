...
def handle_case(case: dict, nova_access: NovaAccess, kombit_access: KombitAccess) -> None:
    ...
    for note in notes:
        ...
        if note_title.startswith(note_prefix):
            ...
            newest_note = note
    # TODO: Do a date check for cases and either return or keep working on it
